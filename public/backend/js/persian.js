...
(function () {
	...
	var arabicNumbers  = ["١", "٢", "٣", "٤", "٥", "٦", "٧", "٨", "٩", "٠"],
		persianNumbers = ["۱", "۲", "۳", "٤", "۵", "٦", "۷", "۸", "۹", "۰"], 
    ...
    function _englishNumber(value) {
        ...
        value=value.toString();
        var englishNumbers = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"],
            arabicNumbers = ["۱", "۲", "۳", "٤", "۵", "٦", "۷", "۸", "۹", "۰"];
    ...
    function _englishNumber2(value) {
        if (!value) {
            return;
        }
        value=value.toString();
     ...
     * @return {Object} PersianJs Object
     */
    function _arabicSwitchKey(value) {
        if (!value) {
            return;
        }
        var persianChar = [ "ض", "ص", "ث", "ق", "ف", "غ", "ع", "ه", "خ", "ح", "ج", "چ", "أ", "س", "ی", "ب", "ل", "ا", "ت", "ن", "م", "ك", "گ", "م", "ط", "ز", "ر", "ذ", "د", "پ", "و","؟" ],
            englishChar = [ "q", "X", "e", "G", "t", "y", "E", "H", "o", "J", "[", "]", "A", "S", "V", "B", "L", "A", "j", "N", "l", "K", "'", "z", "T", "c", "R", "b", "D", "m", "U","?" ];
//        console.log(value.replace(new RegExp(englishChar[0], "g"), persianChar[0]));
        for (var i = 0, charsLen = englishChar.length; i < charsLen; i++) {
            if(englishChar[i]==']'||englishChar[i]=='['||englishChar[i]=='?'){
                englishChar[i]='\\'+englishChar[i];
            }
    ...
    function _englishSwitchKey(value) {
        if (!value) {
            return;
        }
         var persianChar = [ "ض", "ص", "ث", "ق", "ف", "غ", "ع", "ه", "خ", "ح", "ج", "چ", "أ", "س", "ی", "ب", "ل", "ا", "ت", "ن", "م", "ك", "گ", "م", "ط", "ز", "ر", "ذ", "د", "پ", "و","؟" ],
    ...
    persianJs.fn = PersianJs.prototype = {
        ...
        arabicSwitchKey: function() {
            return _arabicSwitchKey.call(this, this._str);
        },
        englishSwitchKey: function() {
            return _englishSwitchKey.call(this, this._str);
        },
