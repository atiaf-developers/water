...
<form role="form"  id="addEditRejectionReasonsForm" enctype="multipart/form-data">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                <input type="hidden" name="id" id="id" value="{{ $rejection_reason->id }}">
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input col-md-4">
                    <input type="number" class="form-control" id="this_order" name="this_order" value="{{ $rejection_reason->this_order }}">
                    <label for="this_order">{{_lang('app.this_order') }}</label>
                    <span class="help-block"></span>
                </div>
                <div class="form-group form-md-line-input col-md-3">
                    <select class="form-control edited" id="active" name="active">
                        <option {{ $rejection_reason->active == 1 ?'selected' : '' }} value="1">{{ _lang('app.active') }}</option>
                        <option {{ $rejection_reason->active == 0 ?'selected' : '' }} value="0">{{ _lang('app.not_active') }}</option>
                    </select>
