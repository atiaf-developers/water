                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                        ...
                                        <div class="portlet yellow-crusta box">
                                            ...
                                            <div class="portlet-body">
                                                <input type="hidden" name="lat" id="lat" value="{{ $order->addressLat}}">
                                                <input type="hidden" name="lng" id="lng" value="{{ $order->addressLng }}">
                                                <div id="map" style="height: 438px; width:100%;"></div>
